...
const QualityManagementSection: React.FC = () => {
    const content1 = `Our experienced staff consists of expert project managers who are experienced in many different sectors and hold the PMP certification. We are by your side to implement and develop the PMP® methodology, which is internationally valid, in your company to strengthen the areas you believe are weak in supporting the management of your projects.`;
